...
<section class="section dashboard">
     <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" method="POST" action="/vendor/products/store">
                  @csrf
                <div class="col-md-6">
                ...
                <div class="col-lg-4">
                  ...
                  <select id="sizes" name='sizes[]' class="form-select @error('sizes') is-invalid @enderror js-example-basic-multiple" multiple style="width: 100%">
                    @if(!empty($sizes))
                ...
                <div class="col-lg-4">
                  ...
                  <select id="colors" name='colors[]' class="form-select @error('colors') is-invalid @enderror js-example-basic-multiple" multiple style="width: 100%">
                    @if(!empty($colors))
                ...
                <div class="col-lg-4">
                  ...
                  <div class="col-lg-4">
                    <label for="shipping_charge" class="form-label">Shipping Fee</label>
                  ...
                  <div class="col-lg-3 p-2">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" id="status" value='1' name='publish_status'>
                  ...
                  <div class="col-lg-3 p-2">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="ready_to_ship" value='1' name='ready_to_ship'>
                        <label class="form-check-label" for="status">
                          Ready To Ship
                      </label>
                      </div>
