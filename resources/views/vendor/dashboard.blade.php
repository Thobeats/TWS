            ...
            <div class="row">
                    ...
                    <table class="table table-borderless datatable">
                        ...
                        <tbody>
                            @forelse ($recent_sales as $sale)
                                <tr>
                                    <th scope="row"><a href="#">#ORDER{{$loop->index}}</a></th>
                                    <td>{{ $sale['firstname'] . " " . $sale['lastname'] }}</td>
                                    <td><a href="#" class="text-primary">{{ $sale['name'] }}</a></td>
                                    <td>${{ number_format($sale['total_price'],2) }}</td>
                                    <td>
                                        <span class='badge {{
                                                        ($sale["status_id"] == 1 ? "bg-warning" :
                                                        ($sale["status_id"] == 2 ? "bg-success" :
                                                        "bg-danger"))
                                                    }}'>
                                                {{ $sale['status'] }}
                                        </span>
                ...
                <div class="card top-selling overflow-auto">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            @forelse ($top_selling as $prd)
                                <tr>
                                    <th scope="row"><img src="{{ url('storage/products/'. json_decode($prd['picture'],true)[0]) }}" alt=""></th>
                                    <td><a href="#" class="text-primary fw-bold">{{ $prd['name'] }}</a></td>
                                    <td>${{ $prd['price'] }}</td>
                                    <td class="fw-bold">{{ number_format($prd['sold']) }}</td>
                                    <td>${{ number_format($prd['revenue']) }}</td>
                                </tr>
                            @empty
        ...
        <div class="col-lg-4">
          ...
          {{-- <div class="card">
            <div class="card-body">
              ...
              <div class="p-2 all_activities text-end mt-3">
                <a href="" class="text-underline">View all activities</a>
              </div>
            </div>
          </div> --}}
          <!-- End Recent Activity -->
