          ...
          @if ($vendor->verify_business == 3)
            <div class="card">
              <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <iframe src="{{ url("/public/storage/". $vendor->proof_of_bus) }}" frameborder="0" height="500px"></iframe>
              </div>
          ...
          @if ($vendor->verify_customer_review == 3)
            <div class="card">
              <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <iframe src="{{url("/public/storage/" . $vendor->customer_review)}}" frameborder="0" height="500px"></iframe>
              </div>
              <div class="p-2 text-end">
                <span class="badge bg-success">Verified <i class="bi bi-check2-circle"></i></span>
              </div>
