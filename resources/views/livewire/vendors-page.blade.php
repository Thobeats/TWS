        ...
        <div class="row mt-2">
            @forelse ($vendors as $vendor)
                <div class="col-lg-3 mt-2">
                    <div class="block2 border p-2">
                        <div class="img-wrapper" style="height: 250px">
                            <img src="{{ $vendor->profile != null ? url('storage/'. $vendor->profile)  : asset('images/blank.jpg') }}" class="card-img-top h-full rounded-circle" style="object-fit: cover; object-position: top center;" alt="{{$vendor->business_name}}">
                        </div>
                        <div class="p-2">
                            <div>
                                <a class="stext-102 home-text" href="/market/vendor/{{$vendor->id}}">{{ $vendor->business_name }}</a>
                            </div>
                        </div>
                    </div>
                </div>
