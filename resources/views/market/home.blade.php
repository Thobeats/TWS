...
<!-- Slider -->
<section class='container-fluid mb-4' style="height:auto;">
    <div class="topVendorSlick">
        @forelse ($topVendors as $index => $tv)
            <div id="screen" class="bg-light">
                <div class="top_vendor_banner">
                    <a href="/market/vendor/{{$tv['vendor_id']}}">
                        <div class="h-100 mx-auto" style="background-image: url('{{ $tv['business_banner'] != "" ? url('storage/' . $tv['business_banner']) : url('images/Welcome.png')}}'); background-size:cover; background-position: left center;"></div>
                    </a>
                </div>
                @foreach ($tv['products'] as $product)
                    <div class="top_vendor_item border">
    ...
    <div class="top_vendors_name">
        <div class="d-flex top_vendors_business_name">
            @forelse ($topVendors as $idx => $tpv)
                <div class="p-3  {{ $idx == 0 ? 'home-link-active' : 'home-link' }} name{{$idx}}" href="#">
                    <a onclick="selectSlide('{{$idx}}')">{{ $tpv['business_name'] }}</a>
                </div>
            @empty
                    ...
                    <div class="block2">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14 border p-3">
                            <div class="block2-txt-child1 flex-col-l">
                                <a href="/market/product/{{$product->id}}" class="stext-102 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                    {{ $product->name }}
                                </a>
                            ...
                            <div class="block2-txt-child2 flex-r p-t-3">
                                <a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2 stext-102" data-product="{{$product->id}}">
                ...
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30">
                        ...
                        <div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
                            <a href="{{ route('shop') }}" class="flex-c-m stext-102 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
                                Shop Now
                            </a>
                        </div>
                    </div>
