                                ...
                                <tr class="table_row">
                                    ...
                                    <td class="column-4">
                                        <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                            ...
                                            <input class="mtext-104 cl3 txt-center num-product" type="number" name="num_product[]" value="{{ $item['num_of_product'] }}">
                                    ...
                                    <td class="column-5" data-price="{{$product->name}}">
                    ...
                    <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                        ...
                        <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                            <p class="stext-111 cl6 p-t-2">
                                {{ $product->shipping_type == 3 ? 'Free Shipping' : 'International Shipping' }}
                            </p>
